...
public class Deliverylogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(view -> {
            ...
            if(db.logindelivery(un, pw)){
                Toast.makeText(this, "Login Successful!", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(this, "Invalid Credentials!", Toast.LENGTH_SHORT).show();
            }
        });
        btnForgot.setOnClickListener(view -> startActivity(new Intent(this, deliveryforgot.class)));
        btnRegister.setOnClickListener(view -> startActivity(new Intent(this, Deliveryregister.class)));
    }
}