...
public class ShowPetrolpump extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_petrolpump);
        ...
        List<Petrolpump> doctors = db.getAllPetrolpumps();


        adapter = new PetrolpumpAdapter(this, doctors);
