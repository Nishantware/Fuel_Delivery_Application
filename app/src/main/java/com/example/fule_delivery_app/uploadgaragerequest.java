...
public class uploadgaragerequest extends AppCompatActivity {

    FusedLocationProviderClient fusedLocationProviderClient;
    TextView textView;
    Button btnGetLocation,btnSave;
    EditText edtName, edtNumber, edtCarNumber, edtType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uploadgaragerequest);
    ...
    private void saveData() {
        ...
        GarajeRequest user = new GarajeRequest(
        ...
        if (db.insertgaragerequest(user)) {
